...
export default function Login() {
  ...
  //    armazenar.executeSql("insert into users (usuario, senha) values (?,?)", [usuario, senha])
  //  })
  //}
  return (
    <>
                  ...
                  <div className="col-md-6 col-lg-7 d-flex align-items-center">
                    <form style={{ paddingLeft: '40px', width: '50vw' }}>
                      ...
                      <div className="form-outline mb-4">
                        <input type="email" id="usuario" className="form-control form-control-lg" style={{ width: '27vw' }} />
                        <label className="form-label" for="form2Example17"> Nome Usuário </label>
                      </div>

                      <div className="form-outline mb-4">
                        <input type="password" id="senha" className="form-control form-control-lg" style={{ width: '27vw' }} />
                        <label className="form-label" for="form2Example27"> Senha </label>
                      </div>
                      <div className="pt-1 mb-4">
                        <button className="btn btn-dark btn-lg btn-block" type="button" style={{ width: '5.9vw', padding: '2px' }}> Login </button>
                      </div>
