  ...
  return (
    <>
      <section
        ...
        style={{ paddingTop: '11.5vh', paddingBottom: '10.2vh', backgroundColor: 'rgba(6, 36, 21, 0.78)', height: '98vh' }}>
        <div
              ...
              <div
                ...
                <div
                  ...
                  <div
                    ...
                    <div
                      ...
                      <img
                        src={oficina01}
                        className="rounded mx-auto d-block" width="300vw"
                ...
                <div
                  ...
                  <blockquote
                    ...
                    <p
                      className="mb-3"
                      style={{ fontFamily: 'Kanit' }}>“A maioria das pessoas não querem o seu produto. Elas querem a transformação que seu produto vai trazer para elas.”</p>
                    <footer
                      className="blockquote-footer"> Érico Rocha <cite
                        title="Source Title"> - especialistas em marketing digital e empreendedorismo digital do Brasil </cite></footer>
                  </blockquote>
                  <h5
                ...
                <div
                  ...
                  <div
                    className="col-sm-4"
                    style={{ paddingTop: '12vh', textAlign: 'center' }}>
                    <button
                      type="button"
                      className="btn btn-dark me-md-6 btn-lg" name="buttonVoltar"
                      onClick={() => history.push(`/home`)}
                      style={{ fontStyle: 'oblique', fontWeight: 'bold' }}> Home </button>
                  </div>
                  <div
                    className="col-md-4">
                    <div
