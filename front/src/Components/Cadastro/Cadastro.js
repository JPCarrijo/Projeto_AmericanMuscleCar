...
//import conexao from '../../../back/config/conexao';
                            ...
                            <div className="card" style={{ borderRadius: '1rem', boxShadow: '10px 12px 15px rgba(3, 1, 0, 0.69)', backgroundColor: '  rgba(350, 240, 190, 0.4)', padding: '5vw' }}>
                                <form className="row g-3" >
                                    ...
                                    <div className="form-group" >
                                        ...
                                        <input type="text" className="form-control" id="inputAddress2" name="nome" style={{ boxShadow: '10px 12px 15px rgba(3, 1, 0, 0.69)' }}></input>
                                    </div>
                                    <div className="form-row">
                                        <div className="form-group col-md-6">
                                            <label for="inputEmail4" style={{ fontWeight: 'bolder', fontStyle: 'oblique' }}>Email</label>
                                            <input type="email" className="form-control" id="inputEmail4" name="email" placeholder="admi@americanmusclecar.com" style={{ boxShadow: '10px 12px 15px rgba(3, 1, 0, 0.69)' }}></input>
                                        </div>
                                        <div className="form-group col-md-6">
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="form-group col-md-4">
                                            <label for="inputCity" style={{ fontWeight: 'bold', fontStyle: 'oblique' }}> Data Nascimento </label>
                                            <input type="text" className="form-control" id="inputCity" style={{ boxShadow: '10px 12px 15px rgba(3, 1, 0, 0.69)' }}></input>
                                        </div>
                                        <div className="form-group col-md-4">
