                                    ...
                                    <div className="col-md-6 col-lg-7 d-flex align-items-center">
                                        <form style={{ paddingLeft: '40px', width: '50vw' }}>
                                            ...
                                            <div className="d-flex align-items-center mb-3 pb-1">
                                                ...
                                                <span className="h1 fw-bold mb-0" style={{ fontFamily: 'Permanent Marker' }}>Recuperar senha</span>
                                            </div>
                                            ...
                                            <div className="pt-1 mb-4">
                                                <button className="btn btn-dark btn-lg btn-block" type="button" style={{ width: '7.5vw', padding: '2px' }}> Avançar </button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
